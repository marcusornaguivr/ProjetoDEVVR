...
public class ConsultaCurso extends javax.swing.JInternalFrame {
    ...
    private GerenciaClasse gerenciaClasse;
    private ConsultaClasse consultaClasse;
    ...
    public ConsultaCurso(ConsultaClasse parent){
        this.consultaClasse = parent;
        initComponents();
        setTitle("Carregar Curso");
    }
    
    public ConsultaCurso(GerenciaClasse parent){
    ...
    private void carregaTabela() {
        ...
        tblCurso.setGridColor(Color.WHITE);
    ...
    private void consultar() {
        ...
        for (Curso c : controller.getCursos(curso)) {
    ...
    private void editar() {
        ...
        if (linhaSelecionada >= 0) {
            curso.setCodigo(Integer.parseInt(tblCurso.getValueAt(linhaSelecionada, 0).toString()));
            curso = controller.buscarPorCodigo(curso);
            CadastroCurso frmCadastro = new CadastroCurso(curso);
    ...
    private void carregar() {
        ...
        if (linhaSelecionada >= 0) {
            ...
            if (gerenciaClasse != null) {
                gerenciaClasse.setCurso(curso);
                this.dispose();
            }else if (consultaClasse != null) {
                consultaClasse.setCurso(curso);
                this.dispose();
            }
        }
    }
